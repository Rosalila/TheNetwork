class ResourceRatingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @resource_rating.save
        ...
        format.json { render :show, status: :created, location: @resource_rating }
      else
  ...
  def update
    respond_to do |format|
      if @resource_rating.update(resource_rating_params)
        ...
        format.json { render :show, status: :ok, location: @resource_rating }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to resource_ratings_url, notice: 'Resource rating was successfully destroyed.' }
  ...
  private
    ...
    def resource_rating_params
      params.require(:resource_rating).permit(:resource_id, :rating)
    end
end

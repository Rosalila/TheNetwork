...
class EnginesControllerTest < ActionController::TestCase
  ...
  test "should create engine" do
    assert_difference('Engine.count') do
      post :create, engine: { description: @engine.description, image: @engine.image, license_id: @engine.license_id, name: @engine.name }
    end
  ...
  test "should update engine" do
    patch :update, id: @engine, engine: { description: @engine.description, image: @engine.image, license_id: @engine.license_id, name: @engine.name }
    assert_redirected_to engine_path(assigns(:engine))
  end

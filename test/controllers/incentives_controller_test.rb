...
class IncentivesControllerTest < ActionController::TestCase
  ...
  test "should create incentive" do
    assert_difference('Incentive.count') do
      post :create, incentive: { amount: @incentive.amount, asset_id: @incentive.asset_id, user_id: @incentive.user_id }
    end
  ...
  test "should update incentive" do
    patch :update, id: @incentive, incentive: { amount: @incentive.amount, asset_id: @incentive.asset_id, user_id: @incentive.user_id }
    assert_redirected_to incentive_path(assigns(:incentive))
  end
